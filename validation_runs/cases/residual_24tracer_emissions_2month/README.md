# residual_24tracer_emissions_2month
...
```text
validation_runs/work/residual_24tracer_emissions_2month/main/geoschem/
validation_runs/work/residual_24tracer_emissions_2month/main/wombat/
```
...
.venv/bin/python tools/compare_validation_run.py \
  validation_runs/cases/residual_24tracer_emissions_2month \
  --mode restart
```
