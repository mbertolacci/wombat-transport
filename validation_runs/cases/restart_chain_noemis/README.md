...
```text
validation_runs/work/restart_chain_noemis/window1/geoschem/
validation_runs/work/restart_chain_noemis/window1/wombat/
validation_runs/work/restart_chain_noemis/window2/geoschem/
validation_runs/work/restart_chain_noemis/window2/wombat/
```
...
.venv/bin/python tools/compare_validation_run.py \
  validation_runs/cases/restart_chain_noemis \
  --mode restart
```
