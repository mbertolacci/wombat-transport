# residual_24tracer_emissions_1day
...
```text
validation_runs/work/residual_24tracer_emissions_1day/main/geoschem/
validation_runs/work/residual_24tracer_emissions_1day/main/wombat/
```
...
.venv/bin/python tools/compare_validation_run.py \
  validation_runs/cases/residual_24tracer_emissions_1day \
  --mode quick
```
