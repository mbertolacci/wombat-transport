...
```text
validation_runs/work/restart_chain_noemis_2month/window1/geoschem/
validation_runs/work/restart_chain_noemis_2month/window1/wombat/
validation_runs/work/restart_chain_noemis_2month/window2/geoschem/
validation_runs/work/restart_chain_noemis_2month/window2/wombat/
```
...
.venv/bin/python tools/compare_validation_run.py \
  validation_runs/cases/restart_chain_noemis_2month \
  --mode restart
```
