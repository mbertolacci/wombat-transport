...
FIELD_MAP = {
    ...
    "u_m_s": ("u_m_s", 1.0, "level"),
    "v_m_s": ("v_m_s", 1.0, "level"),
    "pmid_hpa": ("pmid_hpa", 1.0, "level"),
    "pedge_lower_hpa": ("pedge_lower_hpa", 1.0, "level"),
    "pedge_upper_hpa": ("pedge_upper_hpa", 1.0, "level"),
    "tv_k": ("tv_k", 1.0, "level"),
    "hflux_w_m2": ("hflux_w_m2", 1.0, "column"),
    "eflux_w_m2": ("eflux_w_m2", 1.0, "column"),
    "ustar_m_s": ("ustar_m_s", 1.0, "column"),
    "p_tp1_hpa": ("p_tp1_hpa", 1.0, "column"),
    "p_tp2_hpa": ("p_tp2_hpa", 1.0, "column"),
    "xmass_hpa": ("xmass_hpa", 1.0, "level"),
    "ymass_hpa": ("ymass_hpa", 1.0, "level"),
